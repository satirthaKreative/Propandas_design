        ...
        <div class="col-md-6">
            ...
            <div class="box box-danger">
                ...
                <div class="box-body">
                    ...
                    @endif
                    <form action="{{ url('behindpropandas') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <textarea class="form-control" name="behind_propandas_pdetails" rows="10"></textarea>
                            </div><!-- /.input group -->
                        </div><!-- /.form group -->
                        <div class="clearfix">
