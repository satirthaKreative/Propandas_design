...
class Freelegaldocx extends Controller
{
    ...
    {
        //
        $searchShow = DB::table('adminfreelegaldocxes')
                        ->join('admincategories','adminfreelegaldocxes.cate_id','admincategories.id')
                        ->where('adminfreelegaldocxes.id',$id)
                        ->get();

                        // print_r($searchShow);
                        // die();
        return view('admin.freelegaldocx.show',compact('searchShow'));
    }
    ...
    {
        //
        adminfreelegaldocx::find($id)->delete();
        return redirect()->route('admin-freelegaldoc.index')->with('success','Successfully deleted those data');
    }
}
