...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Aug 25, 2020 at 10:47 AM
...
CREATE TABLE IF NOT EXISTS `academic_models` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `admincateques`;
CREATE TABLE IF NOT EXISTS `admincateques` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `adminfreelegaldocxes`;
CREATE TABLE IF NOT EXISTS `adminfreelegaldocxes` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `adminquestions`;
CREATE TABLE IF NOT EXISTS `adminquestions` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
(1, 'admin', 'admin@gmail.com', 'uploads/admin/avatar.png', 'satirtha63@gmail.com', NULL, '$2y$10$j.pzgbAr1sUMV.r5EaYiYexjstxUNN55h1D3aYfmBCTi6ls/.pc82', 't31a0BFBfFNebuVyjlZbWQGxlQHORDppgt50w79Ct7YYJIJayJShou4ovpFF', NULL, NULL);
...
(1, 'Propandas The Digital Way To Get', 'LEGAL WORK DONE', 'ProPandas is the digital way to get your legal work done. Hire a lawyer online. Because the future requires technology.', 'uploads/banner/90289banner1.jpg', '2020-04-23 04:44:41', '2020-04-23 04:44:41'),
(2, 'Propandas The Digital Way To Get', 'LEGAL WORK DONE1', 'ProPandas is the digital way to get your legal work done. Hire a lawyer online. Because the future requires technology.', 'uploads/banner/83048banner2.jpg', '2020-04-23 04:47:44', '2020-04-23 06:50:11'),
(3, 'Propandas The Digital Way To Get', 'LEGAL WORK DONE', 'ProPandas is the digital way to get your legal work done. Hire a lawyer online. Because the future requires technology.', 'uploads/banner/81452banner3.jpg', '2020-04-23 04:55:06', '2020-04-23 04:55:06');
...
DROP TABLE IF EXISTS `behind_propandas_tbl`;
CREATE TABLE IF NOT EXISTS `behind_propandas_tbl` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
(15, 'uploads/owner-img/85833owner-2.jpg', 'Robin Lumsden', 'Co-Founder', 'Robin Lumsden is the co-founder at ProPandas and managing partner of the business law firm Lumsden & Partner with offices in Vienna, New York, and Silicon Valley and an investor to multiple technology companies and founder of a digital asset hedge fund. He completed degrees at the Universities Berkeley and Stanford was formerly a professional tennis player.', '2020-04-27 06:06:02', '2020-04-27 06:06:02');
...
DROP TABLE IF EXISTS `career_tbl`;
...
DROP TABLE IF EXISTS `category_icon_tbls`;
CREATE TABLE IF NOT EXISTS `category_icon_tbls` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `chat_invitation_tbls`;
CREATE TABLE IF NOT EXISTS `chat_invitation_tbls` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
(1, 1, 'PROPAN125473', 25, 10, 'yes', 1, '2020-08-19 04:31:20', '2020-08-20 06:12:05', 'yes'),
...
(6, 2, 'PROPAN679298', 25, 10, 'yes', 1, '2020-08-20 06:09:10', '2020-08-20 06:13:04', 'yes'),
(7, 4, 'PROPAN602267', 25, 10, 'no', 1, '2020-08-20 06:11:38', '2020-08-20 06:12:37', 'yes');
...
DROP TABLE IF EXISTS `clienttolawyerreview_tbls`;
CREATE TABLE IF NOT EXISTS `clienttolawyerreview_tbls` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
(1, 'Satirtha Das', 'dassatirtha@gmail.com', 'satirtha63@gmail.com', 'test', 'test', NULL, NULL),
(2, 'Satirtha Das', 'dassatirtha@gmail.com', 'satirtha63@gmail.com', 'tr', 'fdg', NULL, NULL),
(3, 'Satirtha Das', 'dassatirtha@gmail.com', 'satirtha63@gmail.com', 'TRE', 'RT', NULL, NULL),
(4, 'Satirtha Das', 'dassatirtha@gmail.com', 'satirtha64@gmail.com', 're', 'tr', NULL, NULL),
(5, 'Satirtha Das', 'dassatirtha@gmail.com', 'satirtha63@gmail.com', 'gsdgs', 'sg', NULL, NULL),
(6, 'Satirtha Das', 'dassatirtha@gmail.com', 'satirtha63@gmail.com', 'u', 'u', NULL, NULL),
(7, 'Satirtha Das', 'dassatirtha@gmail.com', 'satirtha63@gmail.com', 'fr', 'fr', NULL, NULL),
(8, 'Satirtha Das', 'dassatirtha@gmail.com', 'satirtha63@gmail.com', 'test', 'test', NULL, NULL),
(9, 'Satirtha Das', 'dassatirtha@gmail.com', 'satirtha63@gmail.com', 'Customer Support Enquery', 'My Profile Details??', NULL, NULL),
(10, 'Satirtha Das', 'satirtha.kreative@gmail.com', 'satirtha63@gmail.com', 'Customer Query', 'Please Check my Days', NULL, NULL),
(11, 'Satirtha Das', 'dassatirtha@gmail.com', 'satirtha63@gmail.com', 'r', 'dd', NULL, NULL),
(12, 'Satirtha Das', 'dassatirtha@gmail.com', 'satirtha63@gmail.com', 'gn', 'gsg', NULL, NULL),
(13, 'Satirtha Das', 'dassatirtha@gmail.com', 'satirtha63@gmail.com', 'test', 'dsd', NULL, NULL),
(14, 'Satirtha Das', 'dassatirtha@gmail.com', 'satirtha64@gmail.com', 'bvzx', 'zbzb', NULL, NULL),
(15, 'Satirtha Das', 'dassatirtha@gmail.com', 'satirtha63@gmail.com', 'Regarding Support After Job Accept', 'What\'s the package to buy after job delivery service?', NULL, NULL),
(16, 'Satirtha Das', 'dassatirtha@gmail.com', 'satirtha63@gmail.com', 'Regarding Support After Job Accept', 'What\'s the package to buy after job delivery service?', NULL, NULL),
(17, 'Satirtha Das', 'satirtha.kreative@gmail.com', 'satirtha63@gmail.com', 'Regarding Support After Job Accept', 'What\'s the package to buy after job delivery service?', NULL, NULL),
(18, 'Satirtha Das', 'satirtha.kreative@gmail.com', 'satirtha63@gmail.com', 'Regarding Support After Job Accept', 'What\'s the package to buy after job delivery service?', NULL, NULL),
(19, 'Satirtha Das', 'satirtha.kreative@gmail.com', 'satirtha63@gmail.com', 'Regarding Support After Job Accept', 'What\'s the package to buy after job delivery service?', NULL, NULL),
(20, 'Satirtha Das', 'dassatirtha@gmail.com', 'satirtha63@gmail.com', 'test', 'test', NULL, NULL),
(21, 'Satirtha Das', 'dassatirtha@gmail.com', 'das@hotmail.com', 'rrr', 'eee', NULL, NULL);
...
DROP TABLE IF EXISTS `filesize_actual_tbls`;
CREATE TABLE IF NOT EXISTS `filesize_actual_tbls` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `filesize_tbls`;
CREATE TABLE IF NOT EXISTS `filesize_tbls` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `home_probehind_heading_tbl`;
CREATE TABLE IF NOT EXISTS `home_probehind_heading_tbl` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
(1, 'Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.', '2020-04-25 14:02:18', '2020-04-25 14:25:11');
...
DROP TABLE IF EXISTS `howitwork_tbl`;
CREATE TABLE IF NOT EXISTS `howitwork_tbl` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `how_its_works_tbl`;
CREATE TABLE IF NOT EXISTS `how_its_works_tbl` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `jobanswerclinetdesc`;
CREATE TABLE IF NOT EXISTS `jobanswerclinetdesc` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
(5, 25, 2, '6=>kb,5=>34', 91, '10', '', '10', 1, '2020-08-10 12:54:19', '2020-08-14 07:25:05', 'PROPAN766250', 1, 'not_accepting'),
(6, 25, 1, '1=>1,4=>27,6=>testing', 917908194567, '10', '', '10', 1, '2020-08-10 13:15:10', '2020-08-14 07:51:39', 'PROPAN602267', 1, 'not_accepting');
...
DROP TABLE IF EXISTS `job_accept_tbls`;
CREATE TABLE IF NOT EXISTS `job_accept_tbls` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `client_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `job_chat_before_accept_tbls`;
CREATE TABLE IF NOT EXISTS `job_chat_before_accept_tbls` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `lawyertoclientreview_tbls`;
CREATE TABLE IF NOT EXISTS `lawyertoclientreview_tbls` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `reviewer_id` int(11) NOT NULL,
  `review_id` int(11) NOT NULL,
  `review_title` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
...
DROP TABLE IF EXISTS `lawyer_category_models`;
CREATE TABLE IF NOT EXISTS `lawyer_category_models` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `lawyer_cities_tbls`;
CREATE TABLE IF NOT EXISTS `lawyer_cities_tbls` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `lawyer_country_tbls`;
CREATE TABLE IF NOT EXISTS `lawyer_country_tbls` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `lawyer_notify_tbls`;
CREATE TABLE IF NOT EXISTS `lawyer_notify_tbls` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `lawyer_id` int(11) NOT NULL,
  `client_id` int(11) NOT NULL,
  `project_id` int(11) NOT NULL,
...
(1, 35, 25, 23, 'PROPAN409429', 'unread', 1, 1, 'invite', '2020-06-01 18:30:00', '2020-06-01 18:30:00'),
(2, 10, 25, 23, 'PROPAN409429', 'read', 1, 1, 'invite', '2020-06-01 18:30:00', '2020-07-27 10:05:56'),
(3, 10, 25, 24, 'PROPAN277325', 'read', 1, 1, 'invite', '2020-06-28 18:30:00', '2020-07-27 09:40:47'),
(4, 10, 25, 27, 'PROPAN707018', 'read', 1, 1, 'invite', '2020-06-29 18:30:00', '2020-07-27 10:05:55');
...
DROP TABLE IF EXISTS `law_schools_attended_tbls`;
CREATE TABLE IF NOT EXISTS `law_schools_attended_tbls` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `legalinfo`;
CREATE TABLE IF NOT EXISTS `legalinfo` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
INSERT INTO `legalinfo` (`id`, `address_one`, `google_link1`, `address_two`, `google_link2`, `email_address`, `phone_number`, `legal_heading`, `heading_details`, `copyright`, `external_links`, `created_at`, `updated_at`) VALUES
(1, '<p>RF Marketing und Betriebs GmbH<br />\r\nFranzensgasse 11/1,<br />\r\n1050 Wien<br />\r\n&Ouml;sterreich123</p>', 'https://goo.gl/maps/gesmjPwa2DmATZSFA', '<p>Unternehmensgegenstand<br />\r\ndigitale Vermittlung von Rechtsdienstleistungen und Beratung bei der Digitalisier ung des Rechtsdienstleistungsmarktes<br />\r\nFirmenbuchnummer: 509939k<br />\r\nFirmenbuchgericht: Wien<br />\r\nFirmensitz: 1050 Wien</p>', 'https://goo.gl/maps/jEC2UvrRhyuEk1HD6', 'hallo@rechtsfux.at', '+43 1 934 6975', 'Legal Information', '<p>Sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.</p>', '<p>Et harum quidem rerum facilis est et expedita distinctio. Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere.</p>\r\n\r\n<ul>\r\n	<li>Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere.</li>\r\n	<li>Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere.</li>\r\n	<li>Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere.</li>\r\n</ul>', '<p>Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur?</p>\r\n\r\n<p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident.</p>', NULL, '2020-05-26 06:49:06');
...
DROP TABLE IF EXISTS `legal_document_tbls`;
CREATE TABLE IF NOT EXISTS `legal_document_tbls` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `category_id` int(11) DEFAULT NULL,
...
(38, '2020_04_24_051710_create_howitwork_table', 28),
(39, '2020_04_24_101718_create_testimonial_table', 29),
(40, '2020_04_25_132424_create_behind_propandas_table', 30),
(41, '2020_04_25_170955_create_behind_propandas_heading_table', 31),
(42, '2020_05_06_071903_create_contact_query_table', 32),
(43, '2020_05_06_121407_create_legalinfo_table', 33),
(44, '2020_05_07_051707_create-terms-table', 34),
(45, '2020_05_07_064449_create-how_it_works_page-table', 35),
(46, '2020_05_08_084230_create-proposal-tbl', 36),
(47, '2020_05_12_122139_alter_notification_tbl', 37),
(48, '2020_05_12_125158_alter_table_proposal_add_notify_status_column', 38),
(49, '2020_05_14_062041_alter_add_job_answer_client_desc', 39),
(50, '2020_05_25_090430_create_lawyer_country_models_table', 40),
(51, '2020_05_25_090446_create_lawyer_cities_models_table', 41),
(52, '2020_05_26_115331_alter-legalifo-table-google-link-add', 42),
(53, '2020_05_27_064023_create-system-msg-table', 43),
(54, '2020_05_27_103940_alter-system-msg-table', 44),
(55, '2020_05_28_131111_alter-system-msg-tbl', 45),
(56, '2020_05_29_122457_alter-system-msg-tbl', 46),
(57, '2020_06_01_101543_create_lawyer_category_models_table', 47),
(58, '2020_06_02_192151_create_lawyer_notification_models_table', 48),
(59, '2020_06_04_110116_create_academic_models_table', 49),
(60, '2020_06_05_105646_create_law_schools_attended_models_table', 50),
(61, '2020_06_09_112106_alter_all_posted_jobs_tbl', 51),
(62, '2020_06_09_113119_alter_all_posted_jobs_tbl', 52),
(63, '2020_06_09_135039_create_job_acceptence_tbl', 53),
(64, '2020_06_10_062407_alter_in_chat_tbls', 54),
(65, '2020_06_11_061122_alter-job-accept-tbls', 55),
(66, '2020_06_24_055958_create-filesize-table', 56),
(67, '2020_06_24_122929_create-actual-filesize-table', 57),
(68, '2020_06_24_130205_alter-filesize-table', 58),
(69, '2020_06_26_193021_create-client-to-lawyer-review-tbl', 59),
(70, '2020_06_26_194711_create-lawyer-to-client-review-tbl', 59),
(71, '2020_07_07_124915_create-career-tbl', 60),
(72, '2020_07_23_195527_alter-jobanswerclientdesc-tbls-column-add', 61),
(73, '2020_08_04_175349_job_chat_before_accept_tbls', 62),
(74, '2020_08_14_111949_create-chat-invitation-tbl', 63),
(75, '2020_08_19_060442_update-on-chat-invite-tbls', 64),
(76, '2020_08_19_074259_add-column-on-chat-invite-tbls', 65),
(77, '2020_08_21_051923_create-new-icon-category-tbl', 66),
(78, '2020_08_21_193835_create-legal-document-tbl', 67);
...
(1, 'tesy', 'test', 0, '78', 10, 1, 25, 1, 'unread', '2020-08-03 19:12:39', '2020-08-03 19:12:39', 'proposal'),
(2, 'lorem', 'lorem', 1, '10', 23, 1, 25, 1, 'unread', '2020-08-03 19:36:10', '2020-08-03 19:36:10', 'proposal'),
(3, 'bjdfg', ' kfb  f', 1, '89', 23, 4, 25, 1, 'unread', '2020-08-04 20:41:32', '2020-08-04 20:41:32', 'proposal'),
(4, 'lorem', 'lorem', 1, '78', 23, 1, 25, 1, 'unread', '2020-08-06 12:15:21', '2020-08-06 12:15:21', 'proposal'),
(5, 'df', 'jbg', 0, '78', 10, 5, 25, 1, 'unread', '2020-08-10 12:55:01', '2020-08-10 12:55:01', 'proposal');
...
CREATE TABLE IF NOT EXISTS `proposal_tbl` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `lawyer_des` longtext COLLATE utf8mb4_unicode_ci,
  `lawyer_comment` longtext COLLATE utf8mb4_unicode_ci,
  `billing_option` tinyint(4) NOT NULL DEFAULT '0',
...
INSERT INTO `proposal_tbl` (`id`, `lawyer_des`, `lawyer_comment`, `billing_option`, `billing_rate`, `lawyer_id`, `project_id`, `client_id`, `active_status`, `created_at`, `updated_at`) VALUES
(1, 'tesy lorem sub', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.', 0, '78', 10, 1, 25, 1, '2020-08-03 19:12:39', '2020-08-03 19:12:39'),
(4, 'lorem', 'lorem', 1, '78', 23, 1, 25, 1, '2020-08-06 12:15:21', '2020-08-06 12:15:21'),
(5, 'df', 'jbg', 0, '78', 10, 5, 25, 1, '2020-08-10 12:55:01', '2020-08-10 12:55:01');
...
DROP TABLE IF EXISTS `system_msg_tbl`;
CREATE TABLE IF NOT EXISTS `system_msg_tbl` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
(1, 22, 0, NULL, 'PROPAN000045', '\r\nLorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 1, 0, 1, '2020-05-27 05:38:10', '2020-05-27 05:38:10'),
(2, 25, 0, NULL, 'PROPAN159752', '\r\nLorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 1, 1, 1, '2020-05-27 05:41:23', '2020-05-26 18:30:00'),
(3, 25, 0, NULL, 'PROPAN92085', '\r\nLorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 1, 1, 0, '2020-05-27 05:42:22', '2020-05-29 09:37:49'),
(4, 25, 0, NULL, 'PROPAN92085', '\r\nLorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 1, 1, 0, '2020-05-27 05:42:48', '2020-05-29 08:47:11'),
(5, 25, 0, NULL, 'PROPAN92085', '\r\nLorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 1, 1, 0, '2020-05-27 05:44:38', '2020-05-29 08:46:23'),
(6, 10, 1, NULL, 'PROPAN000045', '\r\nLorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 1, 1, 0, '2020-05-27 07:52:08', '2020-06-04 02:27:39'),
(7, 4, 0, NULL, NULL, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 1, 0, 1, '2020-05-28 07:33:43', '2020-05-28 07:33:43'),
(8, 25, 0, NULL, 'PROPAN92085', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', 1, 0, 0, '2020-05-29 06:11:38', '2020-05-29 07:45:38'),
(9, 25, 0, NULL, 'PROPAN000090', 'In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document or a typeface without relying on meaningful content.', 1, 1, 0, '2020-05-29 06:23:03', '2020-05-29 08:46:19'),
(10, 25, 0, NULL, 'PROPAN00001', 'lorem', 1, 1, 0, '2020-05-29 06:29:08', '2020-05-29 07:44:53'),
(11, 10, 1, NULL, 'PROPAN000090', 'lorem', 1, 0, 0, '2020-05-29 06:38:42', '2020-06-04 02:27:35'),
(12, 10, 1, NULL, 'PROPAN000090', 'lorem', 1, 1, 0, '2020-05-29 06:38:43', '2020-05-29 08:49:27'),
(13, 10, 1, NULL, NULL, 'lorem', 1, 1, 0, '2020-05-29 06:40:31', '2020-06-04 02:27:38'),
(14, 25, 0, NULL, 'PROPAN00003', 'In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document or a typeface without relying on meaningful content.', 1, 1, 0, '2020-05-29 09:36:36', '2020-05-29 09:37:46'),
(15, 35, 1, NULL, 'test', 'test', 1, 0, 1, '2020-06-09 02:04:19', '2020-06-09 02:04:19');
...
(1, 'uploads/testimonials/14011clint-logo.jpg', 'I am looking forward to the launch of ProPandas as it will enable me to connect with specialized lawyers on a case-to-case basis with no unnecessary overhead costs or office visits.', 'Sebastian Schwarzenegger', 'Investmentbanker and Entrepreneur', '2020-04-24 06:51:23', '2020-04-24 06:51:23'),
(2, 'uploads/testimonials/93401clint-logo.jpg', 'Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit.', 'Howard K. Stern', 'CEO and Co-Founder', '2020-04-24 06:54:11', '2020-04-24 06:54:11'),
(4, 'uploads/testimonials/65023owner-1.jpg', 'vfsg11', 'Howard K. Stern11', 'Investmentbanker and Entrepreneur11', '2020-04-24 07:08:57', '2020-04-24 07:12:57');
...
DROP TABLE IF EXISTS `timezone_list`;
CREATE TABLE IF NOT EXISTS `timezone_list` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
(4, 'Satirtha4', 'Das', 'highflyer.satirtha001@gmail.com', NULL, 'DE', '07908194389', 'Madhyamgram', 'Madhyamgram', 'kolkata', '700124', '99', 0, '194', NULL, NULL, NULL, NULL, '$2y$10$FT9WihgO4yh6XlUwoGi6TuNTrpEPDvugw1ex3pyaWK0MUrFlxHV.O', 'gxL8fcbOYe0etyLuPZ9EozDIQNcPwDfovhguFOJbEauEowAF1TehDoUDaKJV', '2020-04-07 08:32:07', '2020-04-07 08:32:07', 0),
(10, 'SaT H', 'Das', 'highflyer.satirtha001@gmail.com', 'uploads/dashboard/661713no-img.jpg', 'LL.M.', '7908194389', NULL, NULL, 'berlin', '700124', '80', 1, NULL, 'Jio Law firm', 'Madhyamgram', 'uploads/lawyer_doc/19ticket.pdf', NULL, '$2y$10$g9pW5INg5NxmZHKztStRPO.hmPvRLkhoN9C1XuBSB7CLtq4bnaIGO', 'ykiLa5bGfpZQIIG2QBbjap0iVC80yozXe6KlSbZbINmfJHHync0bdcJ3M3uz', '2020-04-10 07:17:50', '2020-04-25 07:48:30', 1),
(23, 'Satirtha3', 'Das', 'dassatirtha@gmail.com', NULL, 'Dr.', '8942034443', NULL, NULL, 'Kolkata', '700130', '1', 0, NULL, 'United Bank of India', 'Arunachal road', 'uploads/lawyer_doc/19ticket.pdf', NULL, '$2y$10$g9pW5INg5NxmZHKztStRPO.hmPvRLkhoN9C1XuBSB7CLtq4bnaIGO', 'MLsA0ZLNHDzQLvOQE9S4bUWw3y5B3lM13o0cz5PICEjyyuP5ip8Fyxj6zsOr', '2020-04-23 00:48:34', '2020-04-23 00:48:34', 1),
(25, 'Rajakhs', 'Highflyer', 'satirtha.kreative@gmail.com', 'uploads/dashboard/153154no-img.jpg', 'B.tech', '8942034443', 'Arunachal road', 'Madhyamgram', 'Kolkata', '700130', '99', 0, '194', NULL, NULL, NULL, NULL, '$2y$10$NZ48zwh1q19k3DCDoJTe.OZSsYHCDOA.IT6NmoQPaciOy6C01ZVrS', 'q7QxRDMvjxald9dcXjmLeI1ToN7GfJcIa3NFfHDrK7XBlGnOOPO2HrlcLOxz', '2020-04-30 02:06:25', '2020-05-14 23:02:42', 0),
(35, 'goods', 'Raj', 'satirtha64@gmail.com', NULL, 'Mag.', '7001204897', NULL, NULL, 'Kolkata', '700130', '5', 0, NULL, 'United Bank of India', 'Arunachal road', 'uploads/lawyer_doc/screencapture-localhost-8000-how-it-works-1-2020-05-26-20_01_43.pdf', NULL, '$2y$10$g9pW5INg5NxmZHKztStRPO.hmPvRLkhoN9C1XuBSB7CLtq4bnaIGO', 'rVc9EmDXyqXuIm2UZJU13vVPnqSi3NgSAeKVBj0lNCe7T4aIzun9v5PrDTri', '2020-06-01 07:34:09', '2020-06-01 07:34:09', 1),
(36, 'Goods', 'Client', 'satirtha64@gmail.com', NULL, 'B.tech', '7920897650', 'Arunachal road', 'Madhyamgram', 'Kolkata', '700130', '99', 0, '194', NULL, NULL, NULL, NULL, '$2y$10$VJN6kiu8MsdbtzuQmqmfAOt5IAxt6A3kM1w5QwRF4gyjNCBlJOcgm', NULL, '2020-06-02 01:25:25', '2020-06-02 01:25:25', 0),
(42, 'Good', 'Kreative', 'satirtha63@gmail.com', NULL, 'B.tech', '7908194389', 'N0092\r\nMadhyamgram', 'Madhyamgram', 'Kolkata', '700130', '99', 0, '194', NULL, NULL, NULL, NULL, '$2y$10$PvB2qeopzsiDS6vAE7EdM.5l9sCjgMxWEp2/hXwR5oQvcz0eXqRiq', NULL, '2020-07-06 00:18:42', '2020-07-06 00:18:42', 0);
COMMIT;
