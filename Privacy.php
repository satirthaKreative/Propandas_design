...
<section class="basic-content theme-inner">
   <div class="container">
      ...
      <div class="privacy-text">
        <p>Thank you for choosing to be part of our community at Propandas Technologies LLC, doingbusiness as Propandas (“Propandas”, “we”, “us”, or “our”). We are committed to protectingyour personal information and your right to privacy. If you have any questions or concernsabout our policy, or our practices with regards to your personal information, please contactus at <a href="#">office@propandas.com.</a></p>

        <p>When you visit our website <a href="#">http://www.propandas.com</a>, and use our services, you trust uswith your personal information. We take your privacy very seriously. In this privacy policy,we seek to explain to you in the clearest way possible what information we collect, how weuse   it   and   what   rights   you   have   in   relation   to   it.   We   hope   you   take   some   time   to   readthrough it carefully, as it is important. If there are any terms in this privacy policy that youdo not agree with, please discontinue use of our Sites and our services.</p>

        <p>This privacy policy applies to  all information collected through our  website  (such   as http://www.propandas.com),   and/or   any   related   services,   sales,   marketing   or   events   (werefer to them collectively in this privacy policy as the "Services").</p>

        <p>Please read this privacy policy carefully as it will help you make informed decisions aboutsharing your personal information with us.</p>
        <hr>
   ...
   <div class="accordion md-accordion theme-accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
               <!-- Accordion card -->
               <div class="card">
                  <!-- Card header -->
                  <div class="card-header" role="tab" id="headingOne1">
                     <a data-toggle="collapse" data-parent="#accordionEx" href="javascript:void(0)" aria-expanded="true"
                        aria-controls="collapseOne1" data-target="#collapseOne1">
                        <h5>
                           <span class="qs-count">1</span>WHAT INFORMATION DO WE COLLECT?
        ...
        <p>We collect personal information that you voluntarily provide to us when registering at theServices   expressing   an   interest   in   obtaining   information   about   us   or   our   products   andservices, when participating in activities on the Services (such as posting messages in ouronline forums or entering competitions, contests or giveaways) or otherwise contacting us.</p>

        <p>The personal information that we collect depends on the context of your interactions with usand   the   Services,   the   choices   you   make   and   the   products   and   features   you   use.   Thepersonal information we collect can include the following:</p>

        <p>Publicly Available Personal Information. We collect first name, maiden name, last name, andnickname; ID; current and former address; phone numbers; email addresses; business email;business   phone   number;   business   entity   filings,   corporate   affiliations,   and   businessassociates; social media; and other similar data.</p>

        <p>Personal Information Provided by You. We collect taxation, pension, and maternity leave; CVand other job application data such as background checks; passwords; financial information(credit   card   number,   purchase   history,   invoices);   purchase   history;   work   performance,salary, bonuses, and disciplinary actions; and other similar data.</p>

        <p>Payment Data. We collect data necessary to process your payment if you make purchases,such as your payment instrument number (such as a credit card number), and the securitycode  associated with  your payment  instrument.  All payment  data  is stored  by  PropandasTechnologies LLC. You may find their privacy policy link(s) here: _</p>
     ...
     <p>Online Identifiers. We collect devices; applications; tools and protocols, such as IP (Internet Protocol) addresses; cookie identifiers, or others such as the ones used for analytics and marketing; and other similar data.</p>
               ...
               <div class="card">
                  ...
                  <div class="card-header" role="tab" id="headingTwo2">
                     <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="javascript:void(0)"
                        aria-expanded="false" aria-controls="collapseTwo2" data-target="#collapseTwo2">
                        <h5>
                            <span class="qs-count">2</span>HOW DO WE USE YOUR INFORMATION?
   ...
   <p>Below are some definitions that will help you understand the roles and responsibilities of Propandas Technologies LLC:</p>
   ...
   <p>If you provide the data and the instructions, then you are the data controller and Propandas Technologies LLC is the data processor.</p>
   ...
   <p>For other Business Purposes. We may use your information for other Business Purposes, such as data analysis, identifying usage trends, determining the effectiveness of our promotional campaigns and to evaluate and improve our Services, products, marketing and your experience. We may use and store this information in aggregated and anonymized form so that it is not associated with individual end users and does not include personal information. We will not use identifiable personal information without your consent.</p>
               ...
               <div class="card">
                  ...
                  <div class="card-header" role="tab" id="headingThree3">
                     <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="javascript:void(0)"
                        aria-expanded="false" aria-controls="collapseThree3" data-target="#collapseThree3">
                        <h5 class="mb-0">
                          <span class="qs-count">3</span>WILL YOUR INFORMATION BE SHARED WITH ANYONE?
                          <i class="fa fa-angle-down rotate-icon" aria-hidden="true"></i>
                        </h5>
                     </a>
                  </div>
               ...
               <div class="card">
                  ...
                  <div class="card-header" role="tab" id="headingfour">
                     <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="javascript:void(0)"
                        aria-expanded="false" aria-controls="collapsefour"  data-target="#collapsefour">
                        <h5 class="mb-0">
                           <span class="qs-count">4</span>DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?
                           <i class="fa fa-angle-down rotate-icon" aria-hidden="true"></i>
                        </h5>
                     </a>
                  </div>
               ...
               <div class="card">
                  ...
                  <div class="card-header" role="tab" id="headingfive">
                     <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="javascript:void(0)"
                        aria-expanded="false" aria-controls="collapsefive"  data-target="#collapsefive">
                        <h5 class="mb-0">
                           <span class="qs-count">5</span>DO WE USE GOOGLE MAPS?
                           <i class="fa fa-angle-down rotate-icon" aria-hidden="true"></i>
                        </h5>
                     </a>
                  </div>
              ...
              <div class="card">
                  ...
                  <div class="card-header" role="tab" id="headingfive">
                     <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="javascript:void(0)"
                        aria-expanded="false" aria-controls="collapsesix"  data-target="#collapse6">
                        <h5 class="mb-0">
                           <span class="qs-count">6</span>HOW DO WE HANDLE YOUR SOCIAL LOGINS?
                           <i class="fa fa-angle-down rotate-icon" aria-hidden="true"></i>
                        </h5>
                     </a>
                  </div>
                  <!-- Card body -->
                  <div id="collapse6" class="collapse" role="tabpanel" aria-labelledby="headingfour"
                     data-parent="#accordionEx">
                     <div class="card-body">
               ...
               <div class="card">
                  ...
                  <div class="card-header" role="tab" id="headingfive">
                     <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="javascript:void(0)"
                        aria-expanded="false" aria-controls="collapse7"  data-target="#collapse7">
                        <h5 class="mb-0">
                           <span class="qs-count">7</span>WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?
                           <i class="fa fa-angle-down rotate-icon" aria-hidden="true"></i>
                        </h5>
                     </a>
                  </div>
                  <!-- Card body -->
                  <div id="collapse7" class="collapse" role="tabpanel" aria-labelledby="headingfour"
                     data-parent="#accordionEx">
                     <div class="card-body">
               ...
               <div class="card">
                  ...
                  <div class="card-header" role="tab" id="headingfive">
                     <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="javascript:void(0)"
                        aria-expanded="false" aria-controls="collapse8"  data-target="#collapse8">
                        <h5 class="mb-0">
                           <span class="qs-count">8</span>HOW LONG DO WE KEEP YOUR INFORMATION?
                           <i class="fa fa-angle-down rotate-icon" aria-hidden="true"></i>
                        </h5>
                     </a>
                  </div>
                  <!-- Card body -->
                  <div id="collapse8" class="collapse" role="tabpanel" aria-labelledby="headingfour"
                     data-parent="#accordionEx">
                     <div class="card-body">
               ...
               <div class="card">
                  ...
                  <div class="card-header" role="tab" id="headingfive">
                     <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="javascript:void(0)"
                        aria-expanded="false" aria-controls="collapse9"  data-target="#collapse9">
                        <h5 class="mb-0">
                           <span class="qs-count">9</span>HOW DO WE KEEP YOUR INFORMATION SAFE?
                           <i class="fa fa-angle-down rotate-icon" aria-hidden="true"></i>
                        </h5>
                     </a>
                  </div>
                  <!-- Card body -->
                  <div id="collapse9" class="collapse" role="tabpanel" aria-labelledby="headingfour"
                     data-parent="#accordionEx">
                     <div class="card-body">
               ...
               <div class="card">
                  ...
                  <div class="card-header" role="tab" id="headingfive">
                     <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="javascript:void(0)"
                        aria-expanded="false" aria-controls="collapse10"  data-target="#collapse10">
                        <h5 class="mb-0">
                           <span class="qs-count">10</span>DO WE COLLECT INFORMATION FROM MINORS?
                           <i class="fa fa-angle-down rotate-icon" aria-hidden="true"></i>
                        </h5>
                     </a>
                  </div>
                  <!-- Card body -->
                  <div id="collapse10" class="collapse" role="tabpanel" aria-labelledby="headingfour"
                     data-parent="#accordionEx">
                     <div class="card-body">
                       <p>In Short:  We do not knowingly collect data from or market to children under 18 years of age.</p>
                       <p>We do not knowingly solicit data from or market to children under 18 years of age. By using the Services, you represent that you are at least 18 or that you are the parent or guardian of such a minor and consent to such minor dependent’s use of the Services. If we learn that personal information from users less than 18 years of age has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we have collected from children under age 18, please contact us at office@propandas.com.</p>                      
                     </div>
                  </div>
               </div>
               <!-- Accordion card -->
               ...
               <div class="card">
                  ...
                  <div class="card-header" role="tab" id="headingfive">
                     <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="javascript:void(0)"
                        aria-expanded="false" aria-controls="collapse11"  data-target="#collapse11">
                        <h5 class="mb-0">
                           <span class="qs-count">11</span>WHAT ARE YOUR PRIVACY RIGHTS?
                           <i class="fa fa-angle-down rotate-icon" aria-hidden="true"></i>
                        </h5>
                     </a>
                  </div>
                  <!-- Card body -->
                  <div id="collapse11" class="collapse" role="tabpanel" aria-labelledby="headingfour"
                     data-parent="#accordionEx">
                     <div class="card-body">
                      ...
                      <p>If you have questions or comments about your privacy rights, you may email us at office@propandas.com.</p>
               ...
               <div class="card">
                  ...
                  <div class="card-header" role="tab" id="headingfive">
                     <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="javascript:void(0)"
                        aria-expanded="false" aria-controls="collapse12"  data-target="#collapse12">
                        <h5 class="mb-0">
                           <span class="qs-count">12</span>DATA BREACH
                           <i class="fa fa-angle-down rotate-icon" aria-hidden="true"></i>
                        </h5>
                     </a>
                  </div>
                  <!-- Card body -->
                  <div id="collapse12" class="collapse" role="tabpanel" aria-labelledby="headingfour"
                     data-parent="#accordionEx">
                     <div class="card-body">
                       <p>A privacy breach occurs when there is unauthorized access to or collection, use, disclosure or disposal of personal information. You will be notified about data breaches when Propandas Technologies LLC believes you are likely to be at risk or serious harm. For example, a data breach may be likely to result in serious financial harm or harm to your mental or physical well-being. In the event that Propandas Technologies LLC becomes aware of a security breach which has resulted or may result in unauthorized access, use or disclosure of personal information Propandas Technologies LLC will promptly investigate the matter and notify the applicable Supervisory Authority not later than 72 hours after having become aware of it, unless the personal data breach is unlikely to result in a risk to the rights and freedoms of natural persons.
</p>                      
                     </div>
                  </div>
               </div>
               ...
               <div class="card">
                  ...
                  <div class="card-header" role="tab" id="headingfive">
                     <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="javascript:void(0)"
                        aria-expanded="false" aria-controls="collapse13"  data-target="#collapse13">
                        <h5 class="mb-0">
                           <span class="qs-count">13</span>CONTROLS FOR DO-NOT-TRACK FEATURES
                           <i class="fa fa-angle-down rotate-icon" aria-hidden="true"></i>
                        </h5>
                     </a>
                  </div>
                  <!-- Card body -->
                  <div id="collapse13" class="collapse" role="tabpanel" aria-labelledby="headingfour"
                     data-parent="#accordionEx">
                     <div class="card-body">
               ...
               <div class="card">
                  ...
                  <div class="card-header" role="tab" id="headingfive">
                     <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="javascript:void(0)"
                        aria-expanded="false" aria-controls="collapse14"  data-target="#collapse14">
                        <h5 class="mb-0">
                           <span class="qs-count">14</span>DO WE MAKE UPDATES TO THIS POLICY?
                           <i class="fa fa-angle-down rotate-icon" aria-hidden="true"></i>
                        </h5>
                     </a>
                  </div>
                  <!-- Card body -->
                  <div id="collapse14" class="collapse" role="tabpanel" aria-labelledby="headingfour"
                     data-parent="#accordionEx">
                     <div class="card-body">
                       <p>In Short:  We do not knowingly collect data from or market to children under 18 years of age.</p>
                       <p>We do not knowingly solicit data from or market to children under 18 years of age. By using the Services, you represent that you are at least 18 or that you are the parent or guardian of such a minor and consent to such minor dependent’s use of the Services. If we learn that personal information from users less than 18 years of age has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we have collected from children under age 18, please contact us at office@propandas.com.</p>                      
               ...
               <div class="card">
                  ...
                  <div class="card-header" role="tab" id="headingfive">
                     <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="javascript:void(0)"
                        aria-expanded="false" aria-controls="collapse15"  data-target="#collapse15">
                        <h5 class="mb-0">
                           <span class="qs-count">15</span>HOW CAN YOU CONTACT US ABOUT THIS POLICY?
                           <i class="fa fa-angle-down rotate-icon" aria-hidden="true"></i>
                        </h5>
                     </a>
                  </div>
                  <!-- Card body -->
                  <div id="collapse15" class="collapse" role="tabpanel" aria-labelledby="headingfour"
                     data-parent="#accordionEx">
                     <div class="card-body">
                       <p>If you have questions or comments about this policy, you may email us at office@propandas.com or by post to:</p>
                       <p>Propandas Technologies LLC <br>Wiedner Hauptstrasse 120 <br>Vienna 1050   <br>Austria </p>          

                 <p>If you are a resident in the European Economic Area, the "data controller" of your personal information is Propandas Technologies LLC. Propandas Technologies LLC has appointed Ignaz Reinfried to be its representative in the EEA. You can contact them directly regarding the processing of your information by Propandas Technologies LLC, by email at ignaz.reinfried@gmail.com, or by post to:
                </p>   
                <p>Wiedner Hauptstrasse 120 <br>Vienna 1050 <br>Austria</p>  
