      ...
      <div class="owner-list">
         <div class="row">
            <div class="col-sm-4">
               <div class="srvc-item">
                  <div class="img-part">
                     <a href="#"><img src="{{ asset('frontAssets/images/owner-1.jpg') }}" alt="images" class="img-fluid"></a>
                  </div>
                  <div class="img-info">
                     <h5>Janet Jones</h5>
            ...
            <div class="col-sm-4">
               <div class="srvc-item">
                  <div class="img-part">
                     <a href="#"><img src="{{ asset('frontAssets/images/owner-3.jpg') }}" alt="images" class="img-fluid"></a>
                  </div>
                  <div class="img-info">
                     <h5>Eric Peterson</h5>
                     <h6>Bank & Financial Lawyer</h6>
      ...
      <div class="row">
         ...
         <div class="col-sm-7">
            <div class="owl-carousel price-slide owl-theme ">
               <div class="item ">              
                  <img src="{{ asset('frontAssets/images/note-img.jpg') }}" alt="images" >
               </div>
               <div class="item ">              
                  <img src="{{ asset('frontAssets/images/note-img.jpg') }}" alt="images">
               </div>
   ...
   <div class="container">
      <div class="row">
         <div class="col-sm-6">
            <div class="blo-box">
               <div class="blg-img">
                  <img src="{{ asset('frontAssets/images/blog-1.jpg') }}" alt="blg" class="img-fluid">
               </div>
         ...
         <div class="col-sm-6">
            <div class="blo-box">
               <div class="blg-img">
                  <img src="{{ asset('frontAssets/images/blog-2.jpg') }}" alt="blg" class="img-fluid">
               </div>
               <div class="blg-info pops-info">
                  <div class="top-title">
...
<section class="brand-part">
   ...
   <div class="theme-slider ">
      <div class="owl-carousel brand-slider owl-theme ">
         <div class="item ">
            <div class="brnd-img">
               <img src="{{ asset('frontAssets/images/lg-1.jpg') }}" alt="images" >
            </div>
         </div>
         <div class="item ">
            <div class="brnd-img">
         ...
         <div class="item ">
            <div class="brnd-img">
               <img src="{{ asset('frontAssets/images/lg-3.jpg') }}" alt="images" >
            </div>
         </div>
         <div class="item ">
            <div class="brnd-img">
               <img src="{{ asset('frontAssets/images/lg-4.jpg') }}" alt="images" >
            </div>
         </div>
         <div class="item ">
            <div class="brnd-img">
               <img src="{{ asset('frontAssets/images/lg-5.jpg') }}" alt="images" >
            </div>
         </div>
         <div class="item ">
            <div class="brnd-img">
               <img src="{{ asset('frontAssets/images/lg-6.jpg') }}" alt="images" >
            </div>
         </div>
      </div>
   </div>
