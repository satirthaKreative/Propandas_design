         ...
         <div class="col-md-9">
            <div class="profile-content">
               <div class="profile-picture">                 
                  <img id="blah" src="{{ asset('frontAssets/images/clint-logo.jpg') }}" alt="your image" class="profile-icon" />
               ...
               <div class="short-profile">
                  ...
                  <p><i class="fa fa-phone icn-show" aria-hidden="true" ></i>{{ Auth::user()->phn_num }}</p>
                  <p><i class="fa fa-map-marker icn-show" aria-hidden="true" ></i>2361  Brentwood Drive San Marcos Texas <span class="country-name-dashboard"></span></p>
