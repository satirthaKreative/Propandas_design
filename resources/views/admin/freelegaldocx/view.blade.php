    	            ...
    	            <table class="table table-bordered table-striped table-reponsive">
                        ...
                        @if(count($docData)>0)
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('admin-freelegaldoc.destroy',$cateData->main_id) }}" method="post">
                                        <a href="{{ route('admin-freelegaldoc.show',$cateData->main_id) }}" class="btn btn-sm btn-success"><i class="fa fa-eye"></i></a> 
                                        <a href="{{ route('admin-freelegaldoc.edit',$cateData->main_id) }}" class="btn btn-sm btn-info"><i class="fa fa-edit"></i></a>
                                        @csrf
                                        @method('DELETE')
