            ...
            <div class="tab-content">
               <div id="all-tab" class="tab-pane fade show active">
                  ...
                  <div class="chat_list prject-line active_chat">
                        <a href="#">
                           <div class="chat_ib">
                              <h5> <i class="fa fa fa-lock" aria-hidden="true"></i>Project 1</h5>
                           </div>
                        </a>
                     </div>
                     <div class="chat_list prject-line">
                        <a href="#">
                           <div class="chat_ib">
                              <h5><i class="fa fa fa-lock" aria-hidden="true"></i>Project 2</h5>
                           </div>
                        </a>
                     </div>
                     <div class="chat_list prject-line">
               ...
               <div id="all-tab" class="tab-pane fade show active">
                  <div class="inbox_chat ">
                     ...
                     <div class="chat_list active_chat ">
                           ...
                           <div class="chat_ib">
                              <h5>
                              <span class="prv-arow"><a href="#"><i class="fa fa-angle-double-left" aria-hidden="true"></i></a></span>
                              <span class="pj-title"><a href="#">Projects</a></span>
                           </h5>
                           </div>
                     ...
                     <div class="chat_list">                        
                           <a href="#">
                           <div class="chat_ib includ-member">
                              <h5>
                  ...
                  <div class="cont-msg">
                     ...
                     <div class="shrt-view">
                        <ul>
                           ...
                           <li><a href="#" class="reply-thread"  data-toggle="tooltip" data-placement="top" title="Start a Reply"><i class="fa fa-commenting-o" aria-hidden="true"></i></a></li>
            ...
            <div class="modal-body ">
               <div class="center-part">
                  ...
                  <form>
                     ...
                     <input type="submit" name="" value="Send Invite" class="cnt-btn">
                  </form>
               </div>
            </div>
         </div>
...
<script>
 ...
 <script>
      ...
      <script>
         $(document).ready(function(){        
         $(".prject-line").click(function(){
           $(".inbox_people").addClass("show-single-project");
         });
         $(".prv-arow").click(function(){
