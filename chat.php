      ...
      <div class="row">
        ...
        <div class="message-content">
           <div class="inbox_people">
            ...
            <a class="nav-item nav-link" data-toggle="tab" data-target="#active-tab" href="javascript:void(0)" role="tab" aria-selected="false">Active Jobs</a>

            <a class="nav-item nav-link" data-toggle="tab" data-target="#jobs-tab" href="javascript:void(0)" role="tab" aria-selected="false">Open Jobs</a>
            <a class="nav-item nav-link" data-toggle="tab" data-target="#unread-tab" href="javascript:void(0)" role="tab" aria-selected="false">Unread</a>            
          </div>
