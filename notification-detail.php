            ...
            <div class="dsbrd-content">
              ...
              <div class="detail-content notf-detail">
                <div class="row">
                  <div class="col-md-8">
                     <h5>Satirtha Das</h5>                
                 <h6><i class="fa fa-envelope" aria-hidden="true"></i>Satirthadas@gmail.com</h6>
                 <h6><i class="fa fa-phone" aria-hidden="true"></i>+917845127845</h6>
                  </div>
                  <div class="col-md-4">
                 ...
                 <ul>
                              ...
                              <p>
                                 <span><a href="javascript:void(0)" class="dt-btn">Back</a></span>                                
                                 </p>
              </div>                       
