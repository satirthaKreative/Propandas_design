...
class CreateClientToLawyerReviewTbl extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('clientTolawyerReview_tbls', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('clientTolawyerReview_tbls');
    }
}
